        ...
        <div className="fixed inset-0 bg-opacity-100 z-50 flex items-center justify-center">
            <div className="bg-gray-900 rounded-2xl shadow-lg w-[400px] p-6 absolute text-white">
                ...
                <form className="space-y-5">
                    <div>
                        <Input type="date" className="w-full bg-transparent border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500 text-white" />
                    </div>
                    <div>
                        <Input label="Amount" type="number" className="w-full bg-transparent border border-gray-600 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500 text-white" placeholder="0.00" />
                    </div>
                    <div>
                        <label className='inline-block mb-1 pl-1'>Category</label>
                        <Select options={['Food & Dining', 'Transport', 'Shopping', 'Bills & Utilities', 'Healthcare', 'Education', 'Travel', 'Personal Care', 'Other']}/>
                    </div>
                    <div>
